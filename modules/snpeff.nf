process snpeff {
   ...
   snpEff -c ${params.snpeffconfig}/snpEff.config -v L_rabies_GCF000859625 -stats ${params.output}/${x}/${x}_snpeff.html  ${params.output}/${x}/${x}.variants_bcftools.vcf > ${params.output}/${x}/${x}.variants_snpeff.ann.vcf
